...
<div class="row">
                ...
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <table
                                ...
                                <thead>
                                    <tr>
                                        <th data-field="icon" data-visible="true" style="width: 40px;" class="hidden-xs" data-formatter="iconFormatter"><span  class="sr-only">{{ trans('admin/assets/table.icon') }}</span></th>
    ...
    </div><!-- End Assets by Status Graph -->
</div><!-- End Details Row 1 -->
