...
return [
    ...
    'patch'				    => 'Patch',
    'patch_report'			=> 'Patch Log',
    'assets'				=> 'Assets',
    'assets_patched'        => 'assets patched',
    ...
    'bulkpatch'             => 'Bulk Patch',
    'bulkpatch_status'      => 'Patch Status',
    ...
    'dashboard'				=> 'Dashboard',
    'days'      			=> 'days',
    'days_to_next_patch'    => 'Days to Next Patch',
    'date'					=> 'Date',
    ...
    'next'					=> 'Next',
    'next_patch_date'		=> 'Next Patch Date',
    'next_patch_date_help'  => 'If you use patching in your organization, this is usually automatically calculated based on the asset&apos;s last patch date and patch frequency (in <code>Admin Settings &gt; Alerts</code>) and you can leave this blank. You can manually set this date here if you need to, but it must be later than the last patch date. ',
    'patch_images_help'     => 'You can find patch images in the asset\'s history tab.',
    'no_email'              => 'No email address associated with this user',
    'last_patch'		    => 'Last Patch',
    'new'					=> 'new!',
    ...
    'patch_due'             => 'Due for Patch',
    'patch_due_days'        => 'Assets Due for Patch Within :days Day|Assets Due for Patch Within :days Days',
    ...
    'patch_overdue'         => 'Overdue for Patch',
    'accept'                => 'Accept :asset',
    'i_accept'              => 'I accept',
    'i_decline'             => 'I decline',
    ...
    'more_info' => 'More Info',
    'quickscan_bulk_help' => 'Checking this box will edit the asset record to reflect this new location. Leaving it unchecked will simply note the location in the patch log. Note that if this asset is checked out, it will not change the location of the person, asset or location it is checked out to.',
    'whoops' => 'Whoops!',
