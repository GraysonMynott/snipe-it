...
return [
    ...
    'asset_ids'					=> 'Asset IDs',
    'patch_interval'            => 'Patch Interval',
    'patch_interval_help'       => 'If you are required to regularly physically patch your assets, enter the interval in months that you use. If you update this value, all of the "next patch dates" for assets with an upcoming patch date will be updated.',
    'patch_warning_days'        => 'Patch Warning Threshold',
    'patch_warning_days_help'   => 'How many days in advance should we warn you when assets are due for patching?',
...
'ldap_location_help'             => 'The Ldap Location field should be used if <strong>an OU is not being used in the Base Bind DN.</strong> Leave this blank if an OU search is being used.',
    ...
    'notifications_help' => 'Email Alerts & Patch Settings',
